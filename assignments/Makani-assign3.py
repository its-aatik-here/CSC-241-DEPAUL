import code 
#I used this import code to run the code in an interactive shell
...
#I used this part for an interactive shell and got this part using some research over the internet.   
